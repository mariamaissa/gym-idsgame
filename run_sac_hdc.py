...
from gym_idsgame.agents.training_agents.soft_actor_critic.hdc_sac.hdc_sac import HDC_SAC_Agent
from gym_idsgame.agents.training_agents.soft_actor_critic.hdc_sac.hdc_sac_config import HDC_SAC_Config
...
if __name__ == '__main__':
    ...
    for lr in [0.00001]:
        hdc_sac_config = QHDConfig(input_dim=88,
